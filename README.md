...
| [10 – Ausbauplanung](docs/planning/10-ausbauplanung.md) | Post-MVP-Ausbaustufen A–E (Embeddings, Import, Wochen-Impuls, Bilder, Desktop) mit Datenmodell-/API-Erweiterungen und DoD |
